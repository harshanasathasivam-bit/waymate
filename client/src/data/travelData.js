...
export const DESTINATIONS_DATA = [
  {
    ...
    atlasCover: "https://upload.wikimedia.org/wikipedia/commons/0/05/Munnar_tea_plantations.jpg",
  ...
  // 2. Wayanad (Second rich destination)
  {
    ...
    atlasCover: "https://upload.wikimedia.org/wikipedia/commons/8/80/Banasura_Sagar_Dam.jpg",
    ...
    attractions: [
      {
        ...
        rating: 4.8,
        reviewsCount: 1680,
        photo: "https://upload.wikimedia.org/wikipedia/commons/4/42/Edakkal_Caves_Carvings.jpg",
      ...
      },
      {
        ...
        rating: 4.7,
        reviewsCount: 1250,
        photo: "https://upload.wikimedia.org/wikipedia/commons/8/80/Banasura_Sagar_Dam.jpg",
  ...
  // 3. Ooty (Nilgiri Queen)
  {
    ...
    atlasCover: "https://upload.wikimedia.org/wikipedia/commons/7/72/Nilgiri_Mountain_Railway.jpg",
